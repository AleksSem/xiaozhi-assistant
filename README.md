...
### Example 6: Web Search (DuckDuckGo)

Search the internet directly. No API key needed — uses DuckDuckGo HTML search.

**Name:** `search_web`

**Description:** `Search the internet for information. Call this when the user asks to find something online, look up facts, or search for any topic.`
...
**Say to Xiaozhi:** "Search for Home Assistant voice satellite setup" or "Find the latest news about AI"
